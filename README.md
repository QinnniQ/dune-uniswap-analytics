...
| Metric | Description |
|--------|--------------|
| **Volume (USD)** | Daily trading volume of the pool |
| **Fees (USD)** | Estimated daily fees at 0.05% tier |
| **Rolling Fees (7d / 30d)** | Short-term vs. medium-term earnings trend |
| **Top Fee Days** | Days with highest LP returns |
...
- Consistent volume indicates healthy liquidity provisioning.  
